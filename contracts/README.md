...
| 文件 | 状态 | 用途 |
|------|------|------|
| [gateway.v1.yaml](./gateway.v1.yaml) | **Cloud Lite** | health / packs / demos / alarms / projects / incidents / commands / AI / edge / license / education-labs；端口 **13200** |
...
| [schemas/scene.schema.json](./schemas/scene.schema.json) | 场景中台 | 手动 / 策略 / AI |

...
mustContain(
  ...
  [
    ...
    "/integrations/dataluminary/export",
    "ORIGIN_NOT_ALLOWED",
    ...
    "/integrations/vistaremote/bindings",
    "/incidents/{id}",
...
mustContain(
  ...
  [
    ...
    "syncrobrain.incident-report.v1",
    "/integrations/events",
    "/integrations/syncrobrain/telemetry-credits",
    "com.syncrobrain.telemetry-credit.v1",
    "x-doerflow-signature",
    "productCode",
    "offeringCode",
    "sourceTenantId",
...
const requiredSchemas = [
  ...
  "doerflow-telemetry-credit.schema.json",
...
const examplePairs = [
  ...
  ["doerflow-telemetry-credit.json", "doerflow-telemetry-credit.schema.json"],
